...
import { BsSunglasses, BsMoonStarsFill } from "react-icons/bs"
import "./Themes.css"
    ...
    <div>
        <div className={`${showSwitcher ? 'show-switcher' : ''} style__switcher`}>
            ...
            <div className="theme__toggler" onClick={toggleTheme}>
                {theme === 'light-theme' ? <BsMoonStarsFill /> : <BsSunglasses />}
            </div>
            <h3 className="style__switcher-title">Color Change !</h3>
